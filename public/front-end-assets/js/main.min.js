!(function (s) {
    ...
    s("[data-countdown]").each(function () {
        ...
        e.countdown(o, function (s) {
            e.html(
                s.strftime(
                    '<span class="cdown days"><span class="time-count">%-D</span> <p>Days</p></span> <span class="cdown hour"><span class="time-count">%-H</span> <p>Hour</p></span> <span class="cdown minutes"><span class="time-count">%M</span> <p>Min</p></span> <span class="cdown seconds"><span class="time-count">%S</span> <p>Sec</p></span>'
                )
            );
        });
    }),
        ...
        s("#slider-range").slider({
            ...
            values: [0, 999],
            slide: function (e, o) {
                s("#amount").val("$" + o.values[0] + " - $" + o.values[1]);
            },
        }),
        s("#amount").val(
            "$" +
                s("#slider-range").slider("values", 0) +
                " - $" +
