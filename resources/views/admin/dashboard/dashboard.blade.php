...
<div class="container-fluid page__container">
    ...
    <div class="card-group">
        <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"> <i class="material-icons icon-muted icon-30pt">assessment</i> All Orders</div>
                <div class="text-amount ml-auto">42</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons icon-muted icon-30pt">shopping_basket</i> sent</div>
                <div class="text-amount ml-auto">311</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons  icon-muted icon-30pt">perm_identity</i>New Orders</div>
                <div class="text-amount ml-auto">78</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons  icon-muted icon-30pt">perm_identity</i> Not Complete</div>
                <div class="text-amount ml-auto">78</div>
            </div>
        </div>
    </div>
    ...
    <div class="card-group">
        <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"> <i class="material-icons icon-muted icon-30pt">assessment</i> Users </div>
                <div class="text-amount ml-auto">42</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons icon-muted icon-30pt">shopping_basket</i> Employees </div>
                <div class="text-amount ml-auto">311</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons  icon-muted icon-30pt">perm_identity</i>New User</div>
                <div class="text-amount ml-auto">78</div>
            </div>
        </div>
    ...
    <div class="card-group">
        <div class="card card-body text-center">
            ...
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"> <i class="material-icons icon-muted icon-30pt">assessment</i> All products </div>
                <div class="text-amount ml-auto">42</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons icon-muted icon-30pt">shopping_basket</i> Available Products
                </div>
                <div class="text-amount ml-auto">311</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons  icon-muted icon-30pt">perm_identity</i>Discounted Products</div>
                <div class="text-amount ml-auto">78</div>
            </div>
        </div>
        <div class="card card-body text-center">
            <div class="d-flex flex-row align-items-center">
                <div class="card-header__title m-0"><i class="material-icons  icon-muted icon-30pt">perm_identity</i>last week products
                </div>
                <div class="text-amount ml-auto">78</div>
            </div>
        </div>
