                ...
                <tbody class="list"
                    ...
                    <tr>
                        ...
                        <td >{{ $feedback->feedback }}</td>
                          ...
                          <td>
                               <form class="" method="post" action="{{ route('feedback.destroy', $feedback->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <input onclick="return confirm('Are you sure you want to delete this Message?')" type="submit" class="btn btn-danger btn-sm mx-1 float-start PY-3 px-3" value="Delete" />
                                    </form>
                              
                                 <a href="{{route('feedback.updateStatus', $feedback->id)}}"
                                        class="btn btn-sm btn-primary"> aproved
